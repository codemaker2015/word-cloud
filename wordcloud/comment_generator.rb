...
class CommentGenerator
  NEW_CLOUD_URL = "https://raw.githubusercontent.com/codemaker2015/word-cloud/master/previous_clouds/#{CloudTypes::CLOUDLABELS[-2]}_cloud#{CloudTypes::CLOUDLABELS.size - 1}.png"
  ADDWORD = 'add'
  ...
  def generate
    ...
    **:star2: Enjoyed yourself? [Add a word](https://github.com/codemaker2015) to the NEW word cloud :fire:**
